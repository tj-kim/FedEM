...
if __name__ == "__main__":
    ...
    exp_names = ['fedem_defend_ep01','fedem_defend_ep02', 'fedem_defend_ep04']
    exp_method = ['FedEM_adv','FedEM_adv','FedEM_adv']
    exp_num_learners = [3,3,3]
    exp_lr = [0.03, 0.03, 0.03]
    exp_eps = [0.1,0.2,0.3]
    ...
    for itt in range(len(exp_names)):
        ...
        args_.seed = 1234
        args_.verbose = 1
        args_.save_path = 'weights/femnist/ep_sweep/' + exp_names[itt]
